    ...
    return (
      <div className='Container'>
        <div>
          ...
          <div>
            <form>
              <input type='number' placeholder={'MXN'} value={currencyMXN} onChange={this.handlerInput} name={currencyMXN} />
              <input type='number' placeholder={'USD'} value={currencyUSD} onChange={this.handlerInput} name={currencyUSD} />
              <input type='number' placeholder={'EUR'} value={currencyEUR} onChange={this.handlerInput} name={currencyEUR} />
            </form>
          </div>
        </div>
      </div>
